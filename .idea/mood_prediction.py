...
import numpy as np
import pandas as pd
from mood_prediction2 import theSecond
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.movie.start()
        ######我日
        MainWindow.setWindowIcon(QtGui.QIcon('./images/22.jpg'))
        ...
        self.menu.triggered.connect(self.onClickedButton4)

    def onClickedButton1(self):
        pygame.init()
        #print("播放音乐1")
        music_index=['./src/1.mp3','./src/2.mp3','./src/3.mp3','./src/4.mp3',
             './src/5.mp3','./src/6.mp3','./src/7.mp3']
        track = pygame.mixer.music.load(random.choice(music_index))
    ...
    def onClickedButton3(self):
        try:
            ...
            with open('./src/1.txt', 'w') as f:
                f.write(str(self.predictions[0]))
        except:
            self.lineEdit_7.setText('请输入数据')
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "小张心情预测软件"))
